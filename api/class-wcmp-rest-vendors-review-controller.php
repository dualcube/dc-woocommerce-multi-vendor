 ...
 *
 * Handles requests to /vendor/<vendor_id>/reviews.
 *
 ...
 */
class WC_REST_Vendor_Reviews_V1_Controller extends WC_REST_Controller {
	...
	public function register_routes() {
		register_rest_route( $this->namespace, '/' . $this->rest_base, array(
			'args' => array(
				...
				'id' => array(
					'description' => __( 'Unique identifier for the variation.', 'dc-woocommerce-multi-vendor' ),
					'type'        => 'integer',
				),
			),
			array(
			...
			array(
				...
				'args'                => array_merge( $this->get_endpoint_args_for_item_schema( WP_REST_Server::CREATABLE ), array(
					...
					'name' => array(
						'required'    => true,
						'type'        => 'string',
						'description' => __( 'Name of the reviewer.', 'dc-woocommerce-multi-vendor' ),
					),
					'email' => array(
						'required'    => true,
						'type'        => 'string',
	...
	public function prepare_item_for_response( $review, $request ) {
		$data = array(
			...
			'rating'       => (int) get_comment_meta( $review->comment_ID, 'vendor_rating', true ),
	...
	protected function prepare_item_for_database( $request ) {
		$prepared_review = array( 'comment_approved' => 1, 'comment_type' => 'wcmp_vendor_rating' );
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'verified' => array(
					'description' => __( 'Shows if the reviewer bought the vendor or not.', 'dc-woocommerce-multi-vendor' ),
					'type'        => 'boolean',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
