...
if (!class_exists('WCMp_Email_Vendor_Review')) :
     ...
     *
     * @class       WCMp_Email_Vendor_Review
     * @version     3.5.0
     * @package     WooCommerce/Classes/Emails
     * @author      WooThemes
     * @extends     WC_Email
     */
    class WCMp_Email_Vendor_Review extends WC_Email {
        public $vendor;
        ...
        public function get_default_heading() {
            return apply_filters('wcmp_vendor_new_review_email_heading', __('{vendor_name} shop got a new {rating}-star review', 'dc-woocommerce-multi-vendor'), $this->object);
        }
