...
class WCMp_Elementor_StoreRating extends Widget_Base {
	...
	public function get_title() {
		return __( 'Store Rating', 'elementor' );
	}
	...
	public function get_keywords() {
		return [ 'wcmp', 'star', 'rating', 'rate', 'review' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 5,
				'dynamic' => [
					'default' => $wcmp_elementor->wcmp_elementor()->dynamic_tags->tag_data_to_tag_text( null, 'wcmp-store-rating-tag' ),
				],
			]
		);
	...
	protected function get_rating() {
    	...
    	$rating = (float) $wcmp_elementor->get_wcmp_store_data( 'rating' );
